...
use includes\models\site\WWWKalipsoCalendarPricesMonthShortcodeModel;
class WWWKalipsoCalendarPricesMonthShortcodeController extends WWWKalipsoShortcodesController implements WWWKalipsoICreatorInstance
{
    public $model;
    public function __construct() {
        parent::__construct();
        $this->model = WWWKalipsoCalendarPricesMonthShortcodeModel::newInstance();
    }
    /**
    ...
    public function initShortcode()
    {
         ...
         */
        add_shortcode( 'wwwkalipso_calendar_price_month', array(&$this, 'action'));
    }
    /**
