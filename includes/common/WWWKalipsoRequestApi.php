...
class WWWKalipsoRequestApi
{
    const WWWKALIPSO_API_V2 = "http://api.travelpayouts.com/v2";
    const WWWKALIPSO_TOKEN = "b2f8bef81735323aecb33e285da8e694";//AIzaSyDtJOCNcAEta51HBHPMnLTLe3lxX6QQj1o
    const WWWKALIPSO_MARKER = "17942";
    ...
    public function getToken(){
        return "&token=".self::WWWKALIPSO_TOKEN;
    }
    /**
    ...
    public function getCalendarPricesMonth($currency, $origin, $destination, $month = ""){
        ...
        $requestURL = self::WWWKALIPSO_API_V2."/prices/month-matrix?{$currency}{$origin}{$destination}{$month}"
            .$this->getToken();
